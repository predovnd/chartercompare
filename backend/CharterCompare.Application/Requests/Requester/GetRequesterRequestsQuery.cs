...
public class GetRequesterRequestsQuery : IRequest<GetRequesterRequestsResponse>
{
}

public class GetRequesterRequestsResponse
{
    public List<RequesterRequestDto> Requests { get; set; } = new();
}
